            ...
            <table width="268"  border="0" cellpadding="0" cellspacing="0" class="borderedTable">
                <tr>
                  <td colspan="2" valign="top">
                      <img src="images/azikellogo.png" width="335" height="247" /> </td>
                </tr>
              </table>
                  <asp:SqlDataSource ID="dsSqlBirthdays" runat="server" 
                      ConnectionString="<%$ ConnectionStrings:iTecon %>" 
                SelectCommand="SELECT StaffId as AnnouncementId, StaffGUID, DateOfBirth as DatePublished, RTRIM(LTRIM(UPPER(IsNull(Surname,'')) + ' ' + IsNull(OtherNames,''))) AS Message from dbo.HR_Staff_Base WHERE MONTH(DateOfBirth) = MONTH(GETDATE()) ORDER BY datepart(d, DateOfBirth)"> </asp:SqlDataSource>
                  <asp:SqlDataSource ID="dsSqlWeddings" runat="server" 
                      ConnectionString="<%$ ConnectionStrings:iTecon %>" 
                SelectCommand="SELECT StaffId as AnnouncementId,StaffGUID,  WeddingDate as DatePublished, RTRIM(LTRIM(UPPER(IsNull(Surname,'')) + ' ' + IsNull(OtherNames,''))) AS Message from dbo.HR_Staff_Base WHERE MONTH(WeddingDate) = MONTH(GETDATE()) ORDER BY datepart(d, WeddingDate)"> </asp:SqlDataSource>
                  <asp:SqlDataSource ID="dsSqlLeaveApplicants" runat="server" 
                      ConnectionString="<%$ ConnectionStrings:iTecon %>" 
                SelectCommand="SELECT StaffId as AnnouncementId, StaffGUID, DateOfBirth as DatePublished, RTRIM(LTRIM(UPPER(IsNull(Surname,'')) + ' ' + IsNull(OtherNames,''))) AS Message from dbo.HR_Staff_Base WHERE MONTH(DateOfBirth) = MONTH(GETDATE()) + 1 ORDER BY datepart(d, DateOfBirth)"> </asp:SqlDataSource>
              </td>
        ...
        <table width="100%" border="0">
          <tr>
            <td align="left" valign="top" class="borderedTableGrey"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <% If Request.QueryString("b") = "18" Or Request.QueryString("b") = "1" Then%>
              <tr>
                <td width="33%">
                ...
                Width="375px" 
                        Title="Staff Turnover Year-To-Date">
                  ...
                  <ChartArea CornerTopLeft="Square" StartDateOfYear="" 
                    ...
                    <TitleBox Position="Left" Visible="True">
                      ...
                      text="Staff Turnover Year-To-Date" font="Arial, 8pt, style=Bold"> </label>
                    </TitleBox>
                ...
                <td width="2%">&nbsp;</td>
                <td><dotnet:Chart ID="Chart3" runat="server" BorderColor="Black" BorderStyle="None"
                    BorderWidth="1px" Height="200px" ShadingEffectMode="Three" 
                Width="375px" 
                        Title="Staff Training Expenditure Year-To-Date">
                  <DefaultTitleBox Visible="False">
                    <HeaderLabel GlowColor="" Type="UseFont"> </HeaderLabel>
                    <HeaderBackground ShadingEffectMode="None" />
                    <Background ShadingEffectMode="None" />
                  ...
                  <ChartArea CornerTopLeft="Square" StartDateOfYear="" 
                    ...
                    <TitleBox Position="Left" Visible="True">
                      ...
                      <Background ShadingEffectMode="None" />
                      <label color="Black" glowcolor="" type="UseFont" 
                      text="Staff Training Expenditure Year-To-Date" font="Arial, 8pt, style=Bold"> </label>
                    </TitleBox>
                    <LegendBox CornerBottomRight="Cut" Orientation="TopRight" Padding="4">
                      <LabelStyle GlowColor="" Type="UseFont" />
                      <DefaultEntry ShapeType="None">
              ...
              <tr>
                ...
                <td><span class="defaultHeaderTextStyle" style="color:#FD0100">Wedding Anniversaries in <%=MonthName(Month(Now), False).ToUpper%></span></td>
                <td><span class="defaultHeaderTextStyle" style="color:#FD0100">Going on Leave in next 2 weeks</span></td>
              </tr>
              <tr>
                <td width="33%" valign="top">
                    <asp:GridView ID="gvBirthdays" runat="server" DataSourceID="dsSqlBirthdays" 
                      ...
                      DataKeyNames="AnnouncementId" Width="99%" 
                      CellPadding="4" ForeColor="#333333" GridLines="None" 
                        
                        
                        EmptyDataText="&amp;nbsp;&lt;br /&gt;No birthdays to display.&lt;br /&gt;&amp;nbsp;" 
                        PageSize="4" Height="160px">
                  ...
                  <columns>
                    ...
                    <asp:TemplateField HeaderText="Staff Name" SortExpression="Message">
                      <itemtemplate>
                        <a href="<%# "javascript:window.open('modules/hr/photo_zoom.aspx?a=" & Databinder.Eval(Container.DataItem, "StaffGUID").ToString & "','Passport Photograph', 'status,menubar,height=300,width=300');" %>">
                ...
                <td width="33%" valign="top">
                    <asp:GridView ID="gvWeddingAnniversaries" 
                        runat="server" DataSourceID="dsSqlWeddings" 
                      AutoGenerateColumns="False" CssClass="defaultFormElementStyle" 
                      DataKeyNames="AnnouncementId" Width="99%" 
                      CellPadding="4" ForeColor="#333333" GridLines="None" 
                        
                        
                        EmptyDataText="&amp;nbsp;&lt;br /&gt;No wedding anniversaries to display.&lt;br /&gt;&amp;nbsp;" 
                        PageSize="4" Height="160px">
                  ...
                  <columns>
                      <asp:TemplateField HeaderText="S/N" InsertVisible="False" 
                          SortExpression="AnnouncementId">
                          <ItemTemplate>
                              <asp:Label ID="Label3" runat="server" Text='<%# serial2 + 1 %>'></asp:Label>
                          </ItemTemplate>
                          <HeaderStyle HorizontalAlign="Right" />
                          <ItemStyle VerticalAlign="Top" HorizontalAlign="Right" />
                      </asp:TemplateField>
                    <asp:TemplateField HeaderText="Staff Name" SortExpression="Message">
                      <itemtemplate>
                        <a href="<%# "javascript:window.open('modules/hr/photo_zoom.aspx?a=" & Databinder.Eval(Container.DataItem, "StaffGUID").ToString & "','Passport Photograph', 'status,menubar,height=300,width=300');" %>">
                            <asp:Label ID="Label1" runat="server" Text='<%# Left(DataBinder.Eval(Container.DataItem, "Message"),50) %>'></asp:Label>
                        </a>
                      </itemtemplate>
                      <headerstyle HorizontalAlign="Left" />                
                      <itemstyle VerticalAlign="Top" Width="75%" />                
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Date" SortExpression="DatePublished">
                      <edititemtemplate>
                        <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("DatePublished") %>'></asp:TextBox>
                      </edititemtemplate>
                      <itemtemplate>
