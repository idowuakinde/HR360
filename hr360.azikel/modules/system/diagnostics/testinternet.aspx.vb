...
Partial Class modules_system_diagnostics_testinternet
    Inherits System.Web.UI.Page

    Protected Sub btnInternetTest_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnInternetTest.Click
        Dim ret() As String = {"", "", "", "", "", ""}

        Miscellaneous.PingSender.Send(System.Configuration.ConfigurationManager.AppSettings("Diagnostics_IP_Internet"), ret)
