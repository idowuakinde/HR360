<%@ Page Language="VB" AutoEventWireup="false" CodeFile="managedesignations.aspx.vb" Inherits="modules_system_setups_metadata_managedesignations" %>
            ...
            <tr>
                <td colspan="2">
                    <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text=":: Manage Existing Designations"></asp:Label></td>
            </tr>
            <tr>
                <td width="3%">
                    &nbsp;</td>
                <td>
                    <asp:GridView ID="gvUsers" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        CssClass="noBorderedMenuTable" DataKeyNames="DesignationId" 
                            ...
                            <asp:TemplateField HeaderText="Designation Name" 
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox1" runat="server" Columns="40" 
                                        Text='<%# Bind("DesignationName") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                    ...
                    <asp:SqlDataSource ID="dsSqlGetData" runat="server" ConnectionString="<%$ ConnectionStrings:iTecon %>"
                        SelectCommand="STP_HR_SELECTALL_HR_Designation" 
                        DeleteCommand="STP_HR_DELETE_HR_Designation" 
                        DeleteCommandType="StoredProcedure" 
                        InsertCommand="STP_HR_INSERT_HR_Designation" 
                        InsertCommandType="StoredProcedure" SelectCommandType="StoredProcedure" 
                        UpdateCommand="STP_HR_UPDATE_HR_Designation" 
                        ...
                        <InsertParameters>
                            <asp:Parameter Direction="InputOutput" Name="DesignationId" Type="Int32" />
                            <asp:Parameter Name="DesignationName" Type="String" />
                            <asp:Parameter Name="Remark" Type="String" />
                        </InsertParameters>
                    </asp:SqlDataSource>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <asp:Label ID="lblAddNew" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text=":: Add a New Designation"></asp:Label></td>
            </tr>
            <tr>
                <td>
                    &nbsp;</td>
                <td><asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="DesignationId"
                        ...
                        <Fields>
                            ...
                            <asp:TemplateField HeaderText="Designation Name:" 
                                SortExpression="DesignationName">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("DesignationName") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
