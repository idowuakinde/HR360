...
Partial Class modules_profiles_profile_photo_2
    ...
    Protected Sub gvMaster_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvMaster.SelectedIndexChanged
        ...
        gvMaster.SelectedRow.FindControl("imgPassport").Visible = True : CType(gvMaster.SelectedRow.FindControl("imgPassport"), Image).ImageUrl = "~/_uploads/photos/photo_" & gvMaster.SelectedDataKey(1).ToString & ".jpg"
        ...
        gvMaster.SelectedRow.FindControl("imgSignature").Visible = True : CType(gvMaster.SelectedRow.FindControl("imgSignature"), Image).ImageUrl = "~/_uploads/signatures/sign_" & gvMaster.SelectedDataKey(1).ToString & ".jpg"
    ...
    Private Sub UploadPhoto(ByVal fileUploadControl As FileUpload, ByVal destinationFolder As String, ByVal destinationFilePrefix As String)
        ...
        destinationFileName = destinationFilePrefix & gvMaster.SelectedDataKey(1).ToString & ".jpg"
