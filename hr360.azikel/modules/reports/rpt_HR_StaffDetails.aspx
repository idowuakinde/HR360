<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_HR_StaffDetails.aspx.vb" Inherits="modules_reports_rpt_HR_StaffDetails" %>
...
<body>
    ...
    <div>
                ...
                <tr>
                  <td width="85%">
                    <asp:Label ID="lblHeader" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text="REPORTS > HR REPORTS > STAFF DETAILS FOR: "></asp:Label>
        ...
        <asp:GridView ID="gvUsers" runat="server" CssClass="noBorderedMenuTable" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:TemplateField HeaderText="STAFF HR DETAILS">
                    <ItemTemplate>
            ...
            <tr>
                ...
                <td colspan="2" valign="top">
                    ...
                    <asp:SqlDataSource ID="dsSqlGetSpouses" runat="server" 
                        ...
                        <SelectParameters>
                            <asp:ControlParameter ControlID="Label1" Name="StaffCode" 
                                PropertyName="Text" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
            ...
            <tr>
                ...
                <td colspan="2" valign="top">
                    ...
                    <asp:SqlDataSource ID="dsSqlGetChildren" runat="server" 
                        ...
                        <SelectParameters>
                            <asp:ControlParameter ControlID="ddlChooser" Name="StaffCode" 
                ...
                <td colspan="2" valign="top">
                    <asp:GridView ID="gvDetail6" runat="server" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Appr 1?" SortExpression="ApprovedBySuperior">
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Appr 2?" SortExpression="ApprovedByHRManager">
                                <EditItemTemplate>
