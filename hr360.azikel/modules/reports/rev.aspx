  ...
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="2">
      ...
      <tr>
        ...
        <td align="left" valign="middle" class="pageHeaderStyleLASAA"><strong>PAYROLL 
            REPORTS</strong></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
          <tr>
            <td align="center" width="3%">&raquo;</td>
            <td><span style="width: 773px">
              <asp:HyperLink ID="hlnkReport7" runat="server" 
                CssClass="cssHyperLink" 
                NavigateUrl="~/modules/reports/rpt_PAYROLL_Staff_Taxes_Location.aspx">Staff Taxes Report</asp:HyperLink>
            </span></td>
          </tr>
          <tr>
            <td align="center">&nbsp;</td>
            <td><span style="width: 773px">
              <asp:HyperLink ID="hlnkReport98" runat="server" 
                CssClass="cssHyperLink" 
                NavigateUrl="~/modules/reports/rpt_PAYROLL_Staff_Loans.aspx">Staff Loans Report</asp:HyperLink>
            </span></td>
          </tr>
          <tr>
            <td align="center">&nbsp;</td>
            <td><span style="width: 773px">
              <asp:HyperLink ID="hlnkReport94" runat="server" 
                CssClass="cssHyperLink" 
                NavigateUrl="~/modules/reports/rpt_PAYROLL_Staff_Pension.aspx">Staff Pension Report</asp:HyperLink>
            </span></td>
          </tr>
          <tr>
            <td align="center">&nbsp;</td>
            <td><span style="width: 773px">
              <asp:HyperLink ID="hlnkReport9" runat="server" 
                CssClass="cssHyperLink" 
                NavigateUrl="~/modules/reports/rpt_PAYROLL_Staff_Coop.aspx">Staff Co-operative Report</asp:HyperLink>
            </span></td>
          </tr>
          <tr>
            <td align="center">&nbsp;</td>
            <td><span style="width: 773px">
              <asp:HyperLink ID="hlnkReport8" runat="server" 
                CssClass="cssHyperLink" 
                NavigateUrl="~/modules/reports/rpt_PAYROLL_Staff_UnionFOBTOB.aspx">Staff UNION DUES/FOBTOB Report</asp:HyperLink>
            </span></td>
          </tr>
          <tr>
            <td align="center">&nbsp;</td>
            <td><span style="width: 773px">
              <asp:HyperLink ID="hlnkReport97" runat="server" 
                CssClass="cssHyperLink" 
                NavigateUrl="~/modules/reports/rpt_PAYROLL_Staff_Bank_Report.aspx">Staff Bank Report</asp:HyperLink>
            </span></td>
          </tr>
          <tr>
            <td align="center">&nbsp;</td>
            <td><span style="width: 773px">
              <asp:HyperLink ID="hlnkReport95" runat="server" 
                CssClass="cssHyperLink" 
                NavigateUrl="~/modules/reports/rpt_PAYROLL_Staff_Overtime.aspx">Staff Overtime Report</asp:HyperLink>
            </span></td>
          </tr>
          <tr>
            <td align="center">&nbsp;</td>
            <td><span style="width: 773px">
              <asp:HyperLink ID="hlnkReport99" runat="server" 
                CssClass="cssHyperLink" 
                NavigateUrl="~/modules/reports/rpt_PAYROLL_Staff_SpecialAllowances.aspx">Staff Special Allowances Report</asp:HyperLink>
            </span></td>
          </tr>
          <tr>
            <td align="center">&nbsp;</td>
            <td><span style="width: 773px">
              <asp:HyperLink ID="hlnkReport93" runat="server" 
                CssClass="cssHyperLink" 
                NavigateUrl="~/modules/reports/rpt_PAYROLL_Staff_SpecialDeductions.aspx">Staff Special Deductions Report</asp:HyperLink>
            </span></td>
          </tr>
          <tr>
            <td align="center">&nbsp;</td>
            <td><span style="width: 773px">
              <asp:HyperLink ID="hlnkReport96" runat="server" 
                CssClass="cssHyperLink" 
                NavigateUrl="~/modules/reports/rpt_PAYROLL_Staff_PaySlip_Small.aspx">Staff Pay Slip</asp:HyperLink>
            </span></td>
          </tr>
          <tr>
            <td align="center">&nbsp;</td>
            <td><span style="width: 773px">
              <asp:HyperLink ID="hlnkReport100" runat="server" 
                CssClass="cssHyperLink" 
                NavigateUrl="~/modules/reports/rpt_PAYROLL_Ledger.aspx">Detailed Payroll Ledger</asp:HyperLink>
            </span></td>
          </tr>
          <tr>
            <td align="center">&nbsp;</td>
