...
Partial Class modules_hr_input_appraisals_ev2
    Inherits System.Web.UI.Page

    Public selectedStaffGUID As String

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.lblHeader.Text = ":: Year " & Now.Year.ToString & " Employee Appraisal Form (Evaluator 2)"
    ...
    Protected Sub DropDownList5_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        CType(DetailsView1.FindControl("imgPhoto"), Image).ImageUrl = "..\..\_uploads\photos\photo_" & selectedStaffGUID & ".jpg"
    End Sub
End Class
