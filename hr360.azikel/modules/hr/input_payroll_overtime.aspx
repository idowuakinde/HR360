<%@ Page Language="VB" AutoEventWireup="false" CodeFile="input_payroll_overtime.aspx.vb" Inherits="modules_hr_input_payroll_overtime" %>
        ...
        <table border="0" width="100%">
            <tr>
                <td colspan="2">
                        ...
                        Text=":: Edit Previous Overtime Records"></asp:Label></td>
            </tr>
            <tr>
                <td width="3%">&nbsp;
                    </td>
                <td>
                    <asp:GridView ID="gvUsers" runat="server" AutoGenerateColumns="False" AutoGenerateEditButton="True"
                        ...
                        DataSourceID="dsSqlGetData" Width="1400px" CellPadding="4" ForeColor="#333333" 
                        GridLines="None" 
                        EmptyDataText="&amp;nbsp;&lt;br /&gt;No records to display.&lt;br /&gt;&amp;nbsp;" 
                        DataKeyNames="StaffOvertimeId" 
                        AutoGenerateSelectButton="True" AutoGenerateDeleteButton="True" 
                        AllowSorting="True">
                        <Columns>
                            <asp:BoundField DataField="StaffOvertimeId" HeaderText="Id" 
                                InsertVisible="False" ReadOnly="True" SortExpression="StaffOvertimeId" />
                            <asp:TemplateField HeaderText="Staff Id" SortExpression="StaffId">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label9" runat="server" Text='<%# Bind("StaffDetails") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Entry Date" SortExpression="EntryDate">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label8_4" runat="server" Text='<%# Common.GetFriendlyDate(CType(Databinder.Eval(Container.DataItem, "EntryDate"), Date)) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Effective Month" SortExpression="EffectiveMonth">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label7" runat="server" Text='<%# MonthName(CType(DataBinder.Eval(Container.DataItem, "EffectiveMonth"), Int32), false) %>'></asp:Label>
                                    &nbsp;<asp:Label ID="Label8_2" runat="server" 
                                        Text='<%# Bind("EffectiveYear") %>'></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Weekday Hours" SortExpression="HoursWeekday">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("HoursWeekday") %>' 
                                        Columns="5" CssClass="defaultFormElementStyleRightAligned"></asp:TextBox>
                                    &nbsp;hrs
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label5" runat="server" Text='<%# Bind("HoursWeekday") %>'></asp:Label>
                                    &nbsp;hrs
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Weekend Hours" SortExpression="HoursWeekend">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("HoursWeekend") %>' 
                                        Columns="5" CssClass="defaultFormElementStyleRightAligned"></asp:TextBox>
                                    &nbsp;hrs
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("HoursWeekend") %>'></asp:Label>
                                    &nbsp;hrs
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" />
                            ...
                            <asp:TemplateField HeaderText="Days Worked" SortExpression="DaysWorked">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("DaysWorked") %>' 
                                        Columns="5" CssClass="defaultFormElementStyleRightAligned"></asp:TextBox>
                                    &nbsp;days
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label3" runat="server" Text='<%# Bind("DaysWorked") %>'></asp:Label>
                                    &nbsp;days
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Nights Worked" SortExpression="NightsWorked">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("NightsWorked") %>' 
                                        Columns="5" CssClass="defaultFormElementStyleRightAligned"></asp:TextBox>
                                    &nbsp;nights
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("NightsWorked") %>'></asp:Label>
                                    &nbsp;nights
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" />
                    ...
                    <asp:SqlDataSource ID="dsSqlGetData" runat="server" ConnectionString="<%$ ConnectionStrings:iTecon %>"
                        SelectCommand="SELECT [StaffOvertimeId], a.[StaffId], UPPER(b.[Surname]) + ' ' + UPPER(b.[OtherNames]) + ' | ' + UPPER(b.[StaffCode]) + ' | (' + UPPER(c.[DepartmentName]) + ' Department)' AS StaffDetails, a.[EntryDate], [EffectiveMonth], [EffectiveYear], [HoursWeekday], [HoursWeekend], [DaysWorked], [NightsWorked], a.[Remark] FROM [dbo].[HR_PAYROLL_Staff_Overtime] a INNER JOIN dbo.[HR_Staff_Base] b ON a.Remark = b.StaffCode INNER JOIN dbo.[Core_Department] c ON b.Department = left(c.DepartmentName, charindex('.', c.DepartmentName) - 1)" 
                        DeleteCommand="STP_HR_DELETE_HR_PAYROLL_Staff_Overtime" 
                        DeleteCommandType="StoredProcedure" 
                        InsertCommand="STP_HR_INSERT_HR_PAYROLL_Staff_Overtime" 
                        InsertCommandType="StoredProcedure" 
                        UpdateCommand="STP_HR_UPDATE_HR_PAYROLL_Staff_Overtime" 
                        UpdateCommandType="StoredProcedure">
                        <DeleteParameters>
                            <asp:Parameter Name="StaffOvertimeId" Type="Int32" />
                        </DeleteParameters>
                        <UpdateParameters>
                            <asp:Parameter Name="StaffOvertimeId" Type="Int32" />
                            ...
                            <asp:Parameter Name="HoursWeekday" Type="Int32" />
                            <asp:Parameter Name="HoursWeekend" Type="Int32" />
                            <asp:Parameter Name="DaysWorked" Type="Int32" />
                            <asp:Parameter Name="NightsWorked" Type="Int32" />
                            <asp:Parameter Name="Remark" Type="String" />
                        </UpdateParameters>
                        <InsertParameters>
                            <asp:Parameter Direction="InputOutput" Name="StaffOvertimeId" Type="Int32" />
                            <asp:Parameter Name="StaffId" Type="Int32" />
                            <asp:Parameter Name="EntryDate" Type="DateTime" />
                            <asp:Parameter Name="EffectiveMonth" Type="Int32" />
                            <asp:Parameter Name="EffectiveYear" Type="Int32" />
            ...
            <tr>
                <td colspan="2">
                    ...
                    <asp:Label ID="lblAddNew" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text=":: Add a New Overtime Record"></asp:Label></td>
            </tr>
            <tr>
                <td>&nbsp;
                    </td>
                <td>
                    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False"
                        ...
                        AutoGenerateInsertButton="True" DataKeyNames="StaffOvertimeId">
                        <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
                        ...
                        <PagerStyle BackColor="#FFCC66" ForeColor="#333333" HorizontalAlign="Center" />
                        <Fields>
                            <asp:BoundField DataField="StaffOvertimeId" HeaderText="StaffOvertimeId" 
                                InsertVisible="False" ReadOnly="True" SortExpression="StaffOvertimeId" />
                            <asp:TemplateField HeaderText="Staff Concerned:" SortExpression="StaffId">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox9" runat="server" Text='<%# Bind("StaffId") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Entry Date:" SortExpression="EntryDate">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label8_3" runat="server" Text='<%# Bind("EntryDate") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Effective Month:" 
                                SortExpression="EffectiveMonth">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox7" runat="server" Text='<%# Bind("EffectiveMonth") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label7" runat="server" Text='<%# Bind("EffectiveMonth") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Weekday Hours:" SortExpression="HoursWeekday">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("HoursWeekday") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                    <asp:TextBox ID="TextBox5" runat="server" Columns="10" 
                                        Text='<%# Bind("HoursWeekday") %>' 
                            ...
                            <asp:TemplateField HeaderText="Weekend Hours:" SortExpression="HoursWeekend">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("HoursWeekend") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                    <asp:TextBox ID="TextBox4" runat="server" Columns="10" 
                                        Text='<%# Bind("HoursWeekend") %>' 
                                        CssClass="defaultFormElementStyleRightAligned"></asp:TextBox>
                                    &nbsp;hrs
                                </InsertItemTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Days Worked:" SortExpression="DaysWorked">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("DaysWorked") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                    <asp:TextBox ID="TextBox3" runat="server" Columns="10" 
                                        Text='<%# Bind("DaysWorked") %>' 
                                        CssClass="defaultFormElementStyleRightAligned"></asp:TextBox>
                                    &nbsp;days
                                </InsertItemTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Nights Worked:" SortExpression="NightsWorked">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("NightsWorked") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                    <asp:TextBox ID="TextBox2" runat="server" Columns="10" 
                                        Text='<%# Bind("NightsWorked") %>' 
                                        CssClass="defaultFormElementStyleRightAligned"></asp:TextBox>
                                    &nbsp;nights
                                </InsertItemTemplate>
                                <ItemTemplate>
