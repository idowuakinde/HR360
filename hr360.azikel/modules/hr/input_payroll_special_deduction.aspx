<%@ Page Language="VB" AutoEventWireup="false" CodeFile="input_payroll_special_deduction.aspx.vb" Inherits="modules_hr_input_payroll_special_deduction" %>
        ...
        <table border="0" width="100%">
            <tr>
                <td colspan="2">
                        ...
                        Text=":: Edit Previous Special Deductions"></asp:Label></td>
            </tr>
            <tr>
                <td width="3%">&nbsp;
                    </td>
                <td>
                    <asp:GridView ID="gvUsers" runat="server" AutoGenerateColumns="False" AutoGenerateEditButton="True"
                        ...
                        DataKeyNames="SpecialDeductionId" 
                        AutoGenerateSelectButton="True" AutoGenerateDeleteButton="True" 
                        AllowSorting="True">
                        <Columns>
                            <asp:BoundField DataField="SpecialDeductionId" HeaderText="Id" 
                                InsertVisible="False" ReadOnly="True" 
                                SortExpression="SpecialDeductionId" />
                    ...
                    <asp:SqlDataSource ID="dsSqlGetData" runat="server" ConnectionString="<%$ ConnectionStrings:iTecon %>"
                        SelectCommand="SELECT [SpecialDeductionId], a.[StaffId], UPPER(b.[Surname]) + ' ' + UPPER(b.[OtherNames]) + ' | ' + UPPER(b.[StaffCode]) + ' | (' + UPPER(c.[DepartmentName]) + ' Department)' AS StaffDetails, a.[EntryDate], [EffectiveMonth], [EffectiveYear], [Amount], [Purpose], a.[Remark] FROM [dbo].[HR_PAYROLL_Staff_Special_Deduction] a INNER JOIN dbo.[HR_Staff_Base] b ON a.Remark = b.StaffCode INNER JOIN dbo.[Core_Department] c ON b.Department = left(c.DepartmentName, charindex('.', c.DepartmentName) - 1)" 
                        DeleteCommand="STP_HR_DELETE_HR_PAYROLL_Staff_Special_Deduction" 
                        DeleteCommandType="StoredProcedure" 
                        InsertCommand="STP_HR_INSERT_HR_PAYROLL_Staff_Special_Deduction" 
                        InsertCommandType="StoredProcedure" 
                        UpdateCommand="STP_HR_UPDATE_HR_PAYROLL_Staff_Special_Deduction" 
                        UpdateCommandType="StoredProcedure">
                        <DeleteParameters>
                            <asp:Parameter Name="SpecialDeductionId" Type="Int32" />
                        </DeleteParameters>
                        <UpdateParameters>
                            <asp:Parameter Name="SpecialDeductionId" Type="Int32" />
                        ...
                        <InsertParameters>
                            <asp:Parameter Direction="InputOutput" Name="SpecialDeductionId" 
                                Type="Int32" />
                            <asp:Parameter Name="StaffId" Type="Int32" />
                            <asp:Parameter Name="EntryDate" Type="DateTime" />
                            <asp:Parameter Name="EffectiveMonth" Type="Int32" />
            ...
            <tr>
                <td colspan="2">
                    ...
                    <asp:Label ID="lblAddNew" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text=":: Add a New Special Deduction"></asp:Label></td>
            </tr>
            <tr>
                <td>&nbsp;
                    </td>
                <td>
                    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False"
                        ...
                        AutoGenerateInsertButton="True" DataKeyNames="SpecialDeductionId">
                        <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
                        ...
                        <PagerStyle BackColor="#FFCC66" ForeColor="#333333" HorizontalAlign="Center" />
                        <Fields>
                            <asp:BoundField DataField="SpecialDeductionId" HeaderText="SpecialDeductionId" 
                                InsertVisible="False" ReadOnly="True" 
                                SortExpression="SpecialDeductionId" />
