        ...
        <asp:GridView ID="gvMaster" runat="server" CssClass="noBorderedMenuTable" 
            ...
            <AlternatingRowStyle BackColor="White" />
                    ...
                    <asp:SqlDataSource ID="dsSqlGetDetail" runat="server" ConnectionString="<%$ ConnectionStrings:iTecon %>"
                        SelectCommand="SELECT [StaffMisconductId], [StaffId], [BriefSummary], [DetailedDescription], [DateOfMisdemeanour], [PrescribedPunishment], [PunishmentCommencementDate], [PunishmentCompletionDate], [PunishmentCarriedOut], [Remark] FROM [dbo].[HR_Staff_Misconduct] WHERE StaffId = @StaffId" 
