    ...
    <div>
        <table border="0" width="100%">
            <tr>
                <td colspan="2">
                        ...
                        Text=":: Edit Career Movements"></asp:Label></td>
            </tr>
            <tr>
                <td width="3%">&nbsp;
                    </td>
        ...
        <asp:GridView ID="gvMaster" runat="server" CssClass="noBorderedMenuTable" 
            ...
            <Columns>
                ...
                <asp:CommandField SelectText="Show Career Movements" ShowSelectButton="True">
                <ItemStyle Width="80px" />
                </asp:CommandField>
                <asp:TemplateField HeaderText="CAREER MOVEMENTS">
                    <ItemTemplate>
                   ...
                   <br />
                        ...
                        Text=":: Add a Career Movement" CssClass="defaultHeaderTextStyle" 
            ...
            <AlternatingRowStyle BackColor="White" />
                    ...
                    <asp:SqlDataSource ID="dsSqlGetDetail" runat="server" ConnectionString="<%$ ConnectionStrings:iTecon %>"
                        SelectCommand="SELECT [StaffMovementId], [StaffId], [FormerDesignationId], b.[DesignationName] AS FormerDesignation, [NewDesignationId], c.[DesignationName] AS NewDesignation, [MovementType], [EffectiveDate], a.[Remark] FROM [dbo].[HR_Staff_Movement] a INNER JOIN dbo.[HR_Designation] b ON a.FormerDesignationId = b.DesignationId INNER JOIN dbo.[HR_Designation] c ON a.NewDesignationId = c.DesignationId WHERE StaffId = @StaffId" 
