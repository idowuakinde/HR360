<%@ Page Language="VB" AutoEventWireup="false" CodeFile="input_appraisals_ev3.aspx.vb" Inherits="modules_hr_input_appraisals_ev3" %>
                        ...
                        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
                            ...
                            <FooterTemplate>
                                <table border="0" cellpadding="2" cellspacing="2" width="100%">
                                    <tr>
                                        <td align="center" rowspan="8" valign="middle" width="200">
                                            <img border="2" height="120" src="../../images/azikellogo.png" /></td>
                                        <td align="center" rowspan="8" valign="middle">
                                            APPRAISAL GRADE SCALE</td>
                                        <td align="center" width="30">
                                            &nbsp;</td>
                            ...
                            <Fields>
                                ...
                                <asp:TemplateField HeaderText="PLEASE SELECT A STAFF TO EVALUATE:">
                                    <InsertItemTemplate>
                                        ...
                                        <asp:SqlDataSource ID="dsSqlGetSingleStaff" runat="server" 
                                            ...
                                            SelectCommand="SELECT [StaffGUID] AS StaffId, UPPER([Surname]) + ' ' + UPPER([OtherNames]) + ' | ' + UPPER([StaffCode]) + ' | (' + UPPER([DepartmentName]) + ' Department)' AS StaffDetails FROM [HR_Staff_Base] a INNER JOIN [Core_Department] b ON a.Department = left(b.DepartmentName, charindex('.', b.DepartmentName) - 1) ORDER BY StaffDetails">
                                        </asp:SqlDataSource>
                                    </InsertItemTemplate>
                                ...
                                <asp:TemplateField></asp:TemplateField>
                                <asp:TemplateField HeaderText="6). PROMOTE?">
                                    <InsertItemTemplate>
                                        <table width="600px" border="0" class="borderedTable">
                                          <tr valign="top">
                                            <td>
                                                <asp:RadioButtonList ID="rdoPromotion" runat="server" RepeatDirection="Horizontal" 
                                                    Width="200px" RepeatLayout="Table">
