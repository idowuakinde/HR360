...
<body>
    ...
    <div>
        <table width="100%"  border="0" id="TABLE1" onclick="return TABLE1_onclick()">
          <tr>
            <td colspan="2"><asp:Label ID="lblHeader" runat="server" Text=":: Edit Staff Records, or <a href='input_newstaff.aspx'><font color='red'>Add New</font></a> Staff" Font-Bold="True" Font-Size="Small"></asp:Label></td>
          </tr>
          <tr>
            <td width="3%">&nbsp;</td>
            <td valign="middle">
        ...
        <asp:GridView ID="gvUsers" runat="server" CssClass="noBorderedMenuTable" 
            ...
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:HyperLink ID="hLink_NewStaff" runat="server" Font-Bold="True" 
                            NavigateUrl="~/modules/hr/input_newstaff.aspx" ForeColor="Red">New</asp:HyperLink>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <a href="<%# "javascript:window.open('photo_zoom.aspx?a=" & Databinder.Eval(Container.DataItem, "StaffGUID").ToString & "','Passport Photograph', 'status,menubar,height=300,width=300');" %>">
