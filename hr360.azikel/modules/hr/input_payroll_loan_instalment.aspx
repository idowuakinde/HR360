<%@ Page Language="VB" AutoEventWireup="false" CodeFile="input_payroll_loan_instalment.aspx.vb" Inherits="modules_hr_input_payroll_loan_instalment" %>
        ...
        <table border="0" width="100%">
            <tr>
                <td colspan="2">
                        ...
                        Text=":: Edit Previous Loan Payments"></asp:Label></td>
            </tr>
            <tr>
                <td width="3%">&nbsp;
                    </td>
                <td>
                    <asp:GridView ID="gvUsers" runat="server" AutoGenerateColumns="False" AutoGenerateEditButton="True"
                        ...
                        DataSourceID="dsSqlGetData" Width="1600px" CellPadding="4" ForeColor="#333333" 
                        GridLines="None" 
                        EmptyDataText="&amp;nbsp;&lt;br /&gt;No records to display.&lt;br /&gt;&amp;nbsp;" 
                        DataKeyNames="StaffCompanyLoanInstalmentId" 
                        AutoGenerateSelectButton="True" AutoGenerateDeleteButton="True" 
                        AllowSorting="True">
                        <Columns>
                            <asp:BoundField DataField="StaffCompanyLoanInstalmentId" HeaderText="Id" 
                                InsertVisible="False" ReadOnly="True" 
                                SortExpression="StaffCompanyLoanInstalmentId" />
                            <asp:TemplateField HeaderText="Staff Id" SortExpression="StaffId">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label6" runat="server" Text='<%# Bind("StaffDetails") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Entry Date" SortExpression="EntryDate">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("EntryDate") %>' 
                            ...
                            <asp:TemplateField HeaderText="Effective Month" SortExpression="EffectiveMonth">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label4" runat="server" Text='<%# MonthName(CType(Databinder.Eval(Container.DataItem, "EffectiveMonth"), Int32), false) %>'></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="Loan Amount" SortExpression="LoanAmount">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("LoanAmount") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Instalment" SortExpression="InstalmentAmount">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox2" runat="server" Columns="10" 
                                        ...
                                        Text='<%# Bind("InstalmentAmount") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("InstalmentAmount") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Paid Up" SortExpression="PaidUp">
                                <ItemTemplate>
                                    <asp:Label ID="Label7" runat="server" Text='<%# Bind("PaidUp") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox3" runat="server" Columns="10" 
                                        CssClass="defaultFormElementStyleRightAligned" Text='<%# Bind("PaidUp") %>'></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Outstanding" SortExpression="Outstanding">
                                <ItemTemplate>
                                    <asp:Label ID="Label8" runat="server" Text='<%# Bind("Outstanding") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox4" runat="server" Columns="10" 
                                        CssClass="defaultFormElementStyleRightAligned" 
                                        Text='<%# Bind("Outstanding") %>'></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Instalments Left" 
                                SortExpression="InstalmentsLeft">
                                <ItemTemplate>
                                    <asp:Label ID="Label9" runat="server" Text='<%# Bind("InstalmentsLeft") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox6" runat="server" Columns="10" 
                                        CssClass="defaultFormElementStyleRightAligned" 
                                        Text='<%# Bind("InstalmentsLeft") %>'></asp:TextBox>
                                </EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Expiry Month" SortExpression="ExpiryMonth">
                                <ItemTemplate>
                                    <asp:Label ID="Label10" runat="server" 
                                        Text='<%# MonthName(CType(Databinder.Eval(Container.DataItem, "ExpiryMonth"), Int32), false) %>'></asp:Label>
                                    <asp:Label ID="Label11" runat="server" Text='<%# Bind("ExpiryYear") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:DropDownList ID="ddlMonth_2_2" runat="server" 
                                        CssClass="defaultFormElementStyle" SelectedValue='<%# Bind("ExpiryMonth") %>'>
                                        <asp:ListItem Value="1">January</asp:ListItem>
                                        <asp:ListItem Value="2">February</asp:ListItem>
                                        <asp:ListItem Value="3">March</asp:ListItem>
                                        <asp:ListItem Value="4">April</asp:ListItem>
                                    ...
                                    &nbsp;<asp:DropDownList ID="ddlYear_2_2" runat="server" 
                                        CssClass="defaultFormElementStyle" SelectedValue='<%# Bind("EffectiveYear") %>'>
                                        <asp:ListItem Value="2011">2011</asp:ListItem>
                                        <asp:ListItem Value="2010">2010</asp:ListItem>
                                        <asp:ListItem Value="2009">2009</asp:ListItem>
                            ...
                            <asp:BoundField DataField="Remark" HeaderText="Remark" 
                                SortExpression="Remark" ReadOnly="True" Visible="False" />
                        </Columns>
                    ...
                    <asp:SqlDataSource ID="dsSqlGetData" runat="server" ConnectionString="<%$ ConnectionStrings:iTecon %>"
                        ...
                        SelectCommand="SELECT [StaffCompanyLoanInstalmentId], a.[StaffId], UPPER(b.[Surname]) + ' ' + UPPER(b.[OtherNames]) + ' | ' + UPPER(b.[StaffCode]) + ' | (' + UPPER(c.[DepartmentName]) + ' Department)' AS StaffDetails, a.[EntryDate], [EffectiveMonth], [EffectiveYear], LoanAmount, [InstalmentAmount], PaidUp, Outstanding, InstalmentsLeft, ExpiryMonth, ExpiryYear, a.[Remark] FROM [dbo].[HR_PAYROLL_Staff_Company_Loan_Instalment] a INNER JOIN dbo.[HR_Staff_Base] b ON a.Remark = b.StaffCode INNER JOIN dbo.[Core_Department] c On b.Department = left(c.DepartmentName, charindex('.', c.DepartmentName) - 1) " 
                        DeleteCommand="STP_HR_DELETE_HR_PAYROLL_Staff_Company_Loan_Instalment" 
                        DeleteCommandType="StoredProcedure" 
                        InsertCommand="STP_HR_INSERT_HR_PAYROLL_Staff_Company_Loan_Instalment" 
                        InsertCommandType="StoredProcedure" 
                        UpdateCommand="STP_HR_UPDATE_HR_PAYROLL_Staff_Company_Loan_Instalment" 
                        UpdateCommandType="StoredProcedure">
                        <DeleteParameters>
                            <asp:Parameter Name="StaffCompanyLoanInstalmentId" Type="Int32" />
                        </DeleteParameters>
                        <UpdateParameters>
                            <asp:Parameter Name="StaffCompanyLoanInstalmentId" Type="Int32" />
                            ...
                            <asp:Parameter Name="InstalmentAmount" Type="Decimal" />
                            <asp:Parameter Name="PaidUp" Type="Decimal" />
                            <asp:Parameter Name="Outstanding" Type="Decimal" />
                            <asp:Parameter Name="InstalmentsLeft" Type="Int32" />
                            <asp:Parameter Name="ExpiryMonth" Type="Int32" />
                            <asp:Parameter Name="ExpiryYear" Type="Int32" />
                            <asp:Parameter Name="Remark" Type="String" />
                        </UpdateParameters>
                        <InsertParameters>
                            <asp:Parameter Direction="InputOutput" Name="StaffCompanyLoanInstalmentId" 
                                Type="Int32" />
                            <asp:Parameter Name="StaffId" Type="Int32" />
                            <asp:Parameter Name="EntryDate" Type="DateTime" />
                            <asp:Parameter Name="EffectiveMonth" Type="Int32" />
            ...
            <tr>
                <td colspan="2">
                    ...
                    <asp:Label ID="lblAddNew" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text=":: Add a New Loan Payment"></asp:Label></td>
            </tr>
            <tr>
                <td>&nbsp;
                    </td>
                <td>
                    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False"
                        ...
                        <PagerStyle BackColor="#FFCC66" ForeColor="#333333" HorizontalAlign="Center" />
                        <Fields>
                            <asp:BoundField DataField="StaffCompanyLoanInstalmentId" HeaderText="StaffCompanyLoanInstalmentId" 
                                InsertVisible="False" ReadOnly="True" 
                                SortExpression="StaffCompanyLoanInstalmentId" />
                            ...
                            <asp:TemplateField HeaderText="Effective Month:" 
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("EffectiveMonth") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("EffectiveMonth") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Loan Amount:" SortExpression="LoanAmount">
                                <ItemTemplate>
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("LoanAmount") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                    <asp:TextBox ID="TextBox1" runat="server" Columns="10" 
                                        CssClass="defaultFormElementStyleRightAligned" Text='<%# Bind("LoanAmount") %>'></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="Paid Up:" SortExpression="PaidUp">
                                <ItemTemplate>
                                    <asp:Label ID="Label3" runat="server" Text='<%# Bind("PaidUp") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("PaidUp") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                    <asp:TextBox ID="TextBox3" runat="server" Columns="10" 
                                        CssClass="defaultFormElementStyleRightAligned" Text='<%# Bind("PaidUp") %>'></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="Outstanding:" SortExpression="Outstanding">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox7" runat="server" Text='<%# Bind("Outstanding") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Instalments Left:" 
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox8" runat="server" Text='<%# Bind("InstalmentsLeft") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                    <asp:TextBox ID="TextBox6" runat="server" Columns="10" 
                                        CssClass="defaultFormElementStyleRightAligned" 
                            ...
                            <asp:TemplateField HeaderText="Expiry Month:" SortExpression="ExpiryMonth">
                                <ItemTemplate>
                                    <asp:Label ID="Label10" runat="server" Text='<%# Bind("ExpiryMonth") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox9" runat="server" Text='<%# Bind("ExpiryMonth") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                    <asp:DropDownList ID="ddlMonth_4" runat="server" 
                                        CssClass="defaultFormElementStyle" SelectedValue='<%# Bind("ExpiryMonth") %>'>
                                        <asp:ListItem Value="1">January</asp:ListItem>
                                        <asp:ListItem Value="2">February</asp:ListItem>
                                        <asp:ListItem Value="3">March</asp:ListItem>
                                    ...
                                    &nbsp;<asp:DropDownList ID="ddlYear_4" runat="server" 
                                        CssClass="defaultFormElementStyle" SelectedValue='<%# Bind("ExpiryYear") %>'>
                                        <asp:ListItem Value="2011">2011</asp:ListItem>
                                        <asp:ListItem Value="2010">2010</asp:ListItem>
                                        <asp:ListItem Value="2009">2009</asp:ListItem>
                                        <asp:ListItem Value="2008">2008</asp:ListItem>
