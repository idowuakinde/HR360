    ...
    <div>
        <table border="0" width="100%">
            <tr>
                <td colspan="2">
                        ...
                        Text=":: Edit Previous Employments"></asp:Label></td>
            </tr>
            <tr>
                <td width="3%">&nbsp;
                    </td>
        ...
        <asp:GridView ID="gvMaster" runat="server" CssClass="noBorderedMenuTable" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="PREVIOUS EMPLOYMENTS">
                    <ItemTemplate>
            ...
            <AlternatingRowStyle BackColor="White" />
                    ...
                    <asp:SqlDataSource ID="dsSqlGetDetail" runat="server" ConnectionString="<%$ ConnectionStrings:iTecon %>"
                        SelectCommand="SELECT [StaffEmploymentId], [StaffId], [EmployerName], [EmployerAddress], [StartDate], [EndDate], [ExitReason], [LastPay], [Reference], [Remark] FROM [dbo].[HR_Staff_PreviousEmployment] WHERE StaffId = @StaffId" 
