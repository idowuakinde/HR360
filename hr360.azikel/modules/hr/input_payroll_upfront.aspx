<%@ Page Language="VB" AutoEventWireup="false" CodeFile="input_payroll_upfront.aspx.vb" Inherits="modules_hr_input_payroll_upfront" %>
        ...
        <table border="0" width="100%">
            <tr>
                <td colspan="2">
                        ...
                        Text=":: Edit Current Upfront Housing Records"></asp:Label></td>
            </tr>
            <tr>
                <td width="3%">&nbsp;
                    </td>
                <td>
                    <asp:GridView ID="gvUsers" runat="server" AutoGenerateColumns="False" AutoGenerateEditButton="True"
                        ...
                        DataSourceID="dsSqlGetData" Width="1100px" CellPadding="4" ForeColor="#333333" 
                        GridLines="None" 
                        EmptyDataText="&amp;nbsp;&lt;br /&gt;No records to display.&lt;br /&gt;&amp;nbsp;" 
                        DataKeyNames="StaffUpfrontId" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="StaffUpfrontId" HeaderText="Id" 
                                InsertVisible="False" ReadOnly="True" SortExpression="StaffUpfrontId" 
                                Visible="False" />
                            ...
                            <asp:TemplateField HeaderText="Grade Level" SortExpression="JobLevelName">
                                <ItemTemplate>
                                    <asp:Label ID="Label9" runat="server" Text='<%# Bind("JobLevelName") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <asp:SqlDataSource ID="dsSqlGetData" runat="server" ConnectionString="<%$ ConnectionStrings:iTecon %>"
                        SelectCommand="SELECT [StaffUpfrontId], a.[StaffId], UPPER(b.[Surname]) + ' ' + UPPER(b.[OtherNames]) + ' | ' + UPPER(b.[StaffCode]) + ' | (' + UPPER(c.[DepartmentName]) + ' Department)' AS StaffDetails, d.JobLevelName, a.[EntryDate], [EffectiveMonth], [EffectiveYear], a.[Remark] FROM [dbo].[HR_PAYROLL_Staff_UpfrontHousing] a INNER JOIN dbo.[HR_Staff_Base] b ON a.StaffId = b.StaffId INNER JOIN dbo.[Core_Department] c ON b.Department = left(c.DepartmentName, charindex('.', c.DepartmentName) - 1) INNER JOIN dbo.[HR_JobLevel] d ON b.JobLevelId = d.JobLevelId ORDER BY JobLevelName " 
                        DeleteCommand="STP_HR_DELETE_HR_PAYROLL_Staff_UpfrontHousing" 
                        DeleteCommandType="StoredProcedure" 
                        InsertCommand="STP_HR_INSERT_HR_PAYROLL_Staff_UpfrontHousing" 
                        InsertCommandType="StoredProcedure" 
                        UpdateCommand="STP_HR_UPDATE_HR_PAYROLL_Staff_UpfrontHousing" 
                        UpdateCommandType="StoredProcedure">
                        <DeleteParameters>
                            <asp:Parameter Name="StaffUpfrontId" Type="Int32" />
                        </DeleteParameters>
                        <UpdateParameters>
                            <asp:Parameter Name="StaffUpfrontId" Type="Int32" />
                        ...
                        <InsertParameters>
                            <asp:Parameter Direction="InputOutput" Name="StaffUpfrontId" Type="Int32" />
                            <asp:Parameter Name="StaffId" Type="Int32" />
                            <asp:Parameter Name="EntryDate" Type="DateTime" />
                            <asp:Parameter Name="EffectiveMonth" Type="Int32" />
                            <asp:Parameter Name="EffectiveYear" Type="Int32" />
            ...
            <tr>
                <td colspan="2">
                    ...
                    <asp:Label ID="lblAddNew" runat="server" Font-Bold="True" Font-Size="Small" 
                        Text=":: Add a New Upfront Housing Record"></asp:Label></td>
            </tr>
            <tr>
                <td>&nbsp;
                    </td>
                <td>
                    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False"
                        ...
                        AutoGenerateInsertButton="True" DataKeyNames="StaffUpfrontId">
                        <FooterStyle BackColor="#990000" Font-Bold="True" ForeColor="White" />
                        ...
                        <PagerStyle BackColor="#FFCC66" ForeColor="#333333" HorizontalAlign="Center" />
                        <Fields>
                            <asp:BoundField DataField="StaffUpfrontId" HeaderText="StaffUpfrontId" 
                                InsertVisible="False" ReadOnly="True" SortExpression="StaffUpfrontId" />
