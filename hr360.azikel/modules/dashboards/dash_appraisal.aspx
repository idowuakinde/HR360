            ...
            <td valign="top">
                <table border="0" width="100%">
                  <tr>
                    ...
                    <td class="defaultHeaderTextStyle"><asp:Label ID="Label" runat="server" Font-Bold="True">PERFORMANCE TREND IN &#39;HR &amp; ADMIN&#39; DEPARTMENT</asp:Label></td>
                    <td align="right" class="defaultHeaderTextStyle"> 2. </td>
                    <td class="defaultHeaderTextStyle"><asp:Label ID="Label3" runat="server" Font-Bold="True">PERFORMANCE TREND IN &#39;FINANCE&#39; DEPARTMENT</asp:Label></td>
                  </tr>
                  <tr>
                    ...
                    <td align="right" class="defaultHeaderTextStyle">&nbsp;</td>
                    <td class="defaultHeaderTextStyle borderedTable"><dotnet:Chart ID="Chart5" runat="server" BorderColor="Black" BorderStyle="None" BorderWidth="1px"
                  ...
                  <tr>
                    ...
                    <td class="defaultHeaderTextStyle"><asp:Label ID="Label5" runat="server" Font-Bold="True">PERFORMANCE TREND IN &#39;SECURITY&#39; DEPARTMENT</asp:Label></td>
                    <td align="right" class="defaultHeaderTextStyle"> 4. </td>
                    <td class="defaultHeaderTextStyle"><asp:Label ID="Label6" runat="server" Font-Bold="True">PERFORMANCE TREND IN &#39;PROJECTS&#39; DEPARTMENT</asp:Label></td>
                  </tr>
                  <tr>
                    <td align="right" class="defaultHeaderTextStyle">&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <tr>
                        <td width="3%" align="right" class="defaultHeaderTextStyle">
                            5.
                        </td>
                        <td class="defaultHeaderTextStyle" width="47%" colspan="3">
                          <asp:Label ID="Label2" runat="server" Font-Bold="True">PERFORMANCE TREND IN &#39;FACTORY&#39; DEPARTMENT</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3" class="defaultHeaderTextStyle borderedTable" align="center">
                            <dotnet:Chart ID="Chart1" runat="server" BorderColor="Black" 
                    ...
                    <tr>
                      ...
                      <td class="defaultHeaderTextStyle" colspan="3"><asp:Label ID="Label12" runat="server" Font-Bold="True">PERFORMANCE TREND IN &#39;SALES & MARKETING&#39; DEPARTMENT (Showing TOP 150, Click for more...)</asp:Label></td>
                    </tr>
                    <tr>
                      <td align="right" class="defaultHeaderTextStyle">&nbsp;</td>
                      <td colspan="3" class="defaultHeaderTextStyle borderedTable" align="center"><dotnet:Chart ID="Chart8" runat="server" BorderColor="Black" 
                                BorderStyle="None" BorderWidth="1px"
                                Height="220px" ShadingEffectMode="Three" URL="../reports/proc_airlines.aspx"
                                Width="930px">
                        <DefaultTitleBox Visible="False">
