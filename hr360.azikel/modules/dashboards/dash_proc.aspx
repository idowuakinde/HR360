<%@ Page Language="VB" AutoEventWireup="false" CodeFile="dash_proc.aspx.vb" Inherits="modules_dashboards_dashboard_acad" %>
...
<table width="1005"  border="0">
  <tr>
    <td width="999" valign="top"><span class="pageHeaderStyleAMMA">&nbsp;:: KPI Dashboard for the PAYROLL Module</span></td>
  </tr>
  <tr>
    <td valign="top"><table width="100%" border="0">
        ...
        <td colspan="3" class="defaultHeaderTextStyle">
            <asp:Label ID="Label1" runat="server" Font-Bold="True">ANNUAL "SALARY BUDGET" TRACKER</asp:Label></td>
        </tr>
        <tr>
      ...
      <tr>
        ...
        <td width="47%" class="defaultHeaderTextStyle">
            <asp:Label ID="Label2" runat="server" Font-Bold="True">TOTAL SALARIES YEAR-TO-DATE</asp:Label></td>
        <td width="3%" align="right" class="defaultHeaderTextStyle">3.</td>
        <td class="defaultHeaderTextStyle">
            <asp:Label ID="Label3" runat="server" Font-Bold="True">TOTAL SALARIES BY GRADE LEVEL FOR LAST MONTH (<%=MonthName(Now.Month - 1, False).ToUpper%>)</asp:Label></td>
      </tr>
      <tr>
        <td align="right" class="defaultHeaderTextStyle">&nbsp;</td>
        <td class="defaultHeaderTextStyle borderedTable">
            <dotnet:Chart ID="Chart1" 
                runat="server" BorderColor="Black" BorderStyle="None"
                    BorderWidth="1px" Height="220px" ShadingEffectMode="Three" 
                Width="440px" URL="../reports/proc_airlines.aspx">
            <DefaultTitleBox Visible="False">
                <HeaderLabel GlowColor="" Type="UseFont">                </HeaderLabel>
                <HeaderBackground ShadingEffectMode="None" />
                <Background ShadingEffectMode="None" />
                ...
                <Hotspot URL="../reports/proc_airlines.aspx">
                </Hotspot>
            <SmartForecast Start="" TimeSpan="00:00:00" />
            <Background ShadingEffectMode="None" />
            <DefaultLegendBox CornerBottomRight="Cut" Padding="4">
        ...
        <td class="defaultHeaderTextStyle borderedTable">&nbsp;<dotnet:Chart ID="Chart2" 
                runat="server" BorderColor="Black" BorderStyle="None"
                    BorderWidth="1px" Height="220px" ShadingEffectMode="Three" 
                Width="440px" URL="../reports/proc_airports.aspx">
            <DefaultTitleBox Visible="False">
                <HeaderLabel GlowColor="" Type="UseFont">                </HeaderLabel>
                <HeaderBackground ShadingEffectMode="None" />
                <Background ShadingEffectMode="None" />
            ...
            <Hotspot URL="../reports/proc_airports.aspx">
            </Hotspot>
            <SmartForecast Start="" TimeSpan="00:00:00" />
            <Background ShadingEffectMode="None" />
            <DefaultLegendBox CornerBottomRight="Cut" Padding="4">
      ...
      <tr>
        ...
        <td class="defaultHeaderTextStyle"><asp:Label ID="Label13" runat="server" Font-Bold="True">AVERAGE STAFF SALARY YEAR-TO-DATE</asp:Label></td>
        <td align="right" class="defaultHeaderTextStyle">5.</td>
        <td class="defaultHeaderTextStyle"><asp:Label ID="Label12" runat="server" Font-Bold="True">AVERAGE STAFF SALARY BY GRADE LEVEL FOR LAST MONTH (<%=MonthName(Now.Month - 1, False).ToUpper%>)</asp:Label></td>
      </tr>
      <tr>
        <td align="right" class="defaultHeaderTextStyle">&nbsp;</td>
        <td class="defaultHeaderTextStyle borderedTable">
            <dotnet:Chart ID="Chart7" runat="server" BorderColor="Black" BorderStyle="None"
                    BorderWidth="1px" Height="220px" ShadingEffectMode="Three" 
                Width="440px" URL="../reports/proc_airlines_cargo.aspx">
            <DefaultTitleBox Visible="False">
              <HeaderLabel GlowColor="" Type="UseFont"> </HeaderLabel>
              <HeaderBackground ShadingEffectMode="None" />
              <Background ShadingEffectMode="None" />
        ...
        <td class="defaultHeaderTextStyle borderedTable">
            <dotnet:Chart ID="Chart6" runat="server" BorderColor="Black" BorderStyle="None" BorderWidth="1px"
                ...
                Width="440px" URL="../reports/proc_airports_cargo.aspx">
            <DefaultTitleBox Visible="False">
              <HeaderLabel GlowColor="" Type="UseFont"> </HeaderLabel>
              <HeaderBackground ShadingEffectMode="None" />
              <Background ShadingEffectMode="None" />
              <label glowcolor="" type="UseFont"> </label>
                ...
                <Hotspot URL="../reports/proc_airports_cargo.aspx">
                </Hotspot>
            <SmartForecast Start="" TimeSpan="00:00:00" />
            <Background ShadingEffectMode="None" />
            <DefaultLegendBox CornerBottomRight="Cut" Padding="4">
      ...
      <tr>
        ...
        <td class="defaultHeaderTextStyle"><asp:Label ID="Label10" runat="server" Font-Bold="True">SALARIES BY DEPARTMENT FOR LAST MONTH (<%=MonthName(Now.Month - 1, False).ToUpper%>)</asp:Label></td>
        <td align="right" class="defaultHeaderTextStyle"> 7.</td>
        <td class="defaultHeaderTextStyle"><asp:Label ID="Label11" runat="server" Font-Bold="True">SALARIES BY EXPENDITURE CATEGORY FOR LAST MONTH (<%=MonthName(Now.Month - 1, False).ToUpper%>)</asp:Label></td>
      </tr>
      <tr>
        ...
        <td class="defaultHeaderTextStyle borderedTable" style="height: 15px">
            <dotnet:Chart ID="Chart4" 
                runat="server" BorderColor="Black" BorderStyle="None"
                    BorderWidth="1px" Height="220px" ShadingEffectMode="Three" 
                Width="440px" URL="../reports/proc_airlines_pass.aspx">
            <DefaultTitleBox Visible="False">
              <HeaderLabel GlowColor="" Type="UseFont"> </HeaderLabel>
              <HeaderBackground ShadingEffectMode="None" />
              <Background ShadingEffectMode="None" />
              <label glowcolor="" type="UseFont"> </label>
                ...
                <Hotspot URL="../reports/proc_airlines_pass.aspx">
                </Hotspot>
            <SmartForecast Start="" TimeSpan="00:00:00" />
            <Background ShadingEffectMode="None" />
            <DefaultLegendBox CornerBottomRight="Cut" Padding="4">
        ...
        <td class="defaultHeaderTextStyle borderedTable" style="height: 15px">
            <dotnet:Chart ID="Chart5" runat="server" BorderColor="Black" BorderStyle="None"
                    BorderWidth="1px" Height="220px" ShadingEffectMode="Three" 
                Width="440px" URL="../reports/proc_airports_pass.aspx">
              <DefaultTitleBox Visible="False">
                <HeaderLabel GlowColor="" Type="UseFont"> </HeaderLabel>
                <HeaderBackground ShadingEffectMode="None" />
                <Background ShadingEffectMode="None" />
                ...
                <Hotspot URL="../reports/proc_airports_pass.aspx">
                </Hotspot>
              <SmartForecast Start="" TimeSpan="00:00:00" />
              <Background ShadingEffectMode="None" />
              <DefaultLegendBox CornerBottomRight="Cut" Padding="4">
