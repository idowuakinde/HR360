<%@ Page Language="VB" AutoEventWireup="false" CodeFile="staff_dashboard.aspx.vb" Inherits="modules_selfservice_staff_dashboard" %>
            ...
            <td valign="top">
                <table border="0" width="100%">
                  <tr>
                    ...
                    <td class="defaultHeaderTextStyle"><asp:Label ID="Label" runat="server" Font-Bold="True">AGES OF STAFF IN MY DEPARTMENT</asp:Label></td>
                    <td align="right" class="defaultHeaderTextStyle"> 2. </td>
                    <td class="defaultHeaderTextStyle"><asp:Label ID="Label3" runat="server" Font-Bold="True">YEARS-OF-SERVICE OF STAFF IN MY DEPARTMENT</asp:Label></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="defaultHeaderTextStyle"><asp:Label ID="Label5" runat="server" Font-Bold="True">HEIGHTS OF STAFF IN MY DEPARTMENT</asp:Label></td>
                    <td align="right" class="defaultHeaderTextStyle"> 4. </td>
                    <td class="defaultHeaderTextStyle"><asp:Label ID="Label6" runat="server" Font-Bold="True">WEIGHTS OF STAFF IN MY DEPARTMENT</asp:Label></td>
                  </tr>
                  <tr>
                    <td align="right" class="defaultHeaderTextStyle">&nbsp;</td>
                    <td class="defaultHeaderTextStyle borderedTable">
                        <dotnet:Chart ID="Chart7" 
                            runat="server" BorderColor="Black" BorderStyle="None" BorderWidth="1px"
